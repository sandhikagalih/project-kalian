# project-kalian - Season 3

## Menyimpan daftar Project Kalian yang sudah disubmit di Discord

Setiap minggunya akan ditampilkan kurang lebih 10 project
silahkan saksikan di youtube.com/@sandhikagalihWPU
setiap hari Sabtu, pukul 19.45WIB (jika tidak ada perubahan :p)

### 11 Juni 2023

1.  [https://adityasemara.web.app/]  
     **AdityaSemaraPutra**

    Halo Pak Sandhika dan Teman-teman semuanya, Perkenalkan nama saya Aditya Semara, Saya ingin membagikan website Portfolio saya. Website ini merupakan hasil dari saya belajar react.js .Website ini saya design dengan konsep modern minimalist. Pada website ini ada beberapa menu navigasi atau tombol yang masih belum berfungsi dikarenakan website ini masih dalam tahap pengembangan.
    ...
    Link Website: https://adityasemara.web.app/

    Terima kasih Pak Sandhika dan Teman-teman semuanya.

<br>

2.  [https://aliffaizar.com/]  
     **alifpaizar**

    hallo Pak dika dan kawan-kawan.
    Perkenalkan nama saya Alif faizar, saya mau share portfolio.
    berikut teknologi yang saya gunakan:
    - Next.js
    - TailwindCSS
    - TypeScript

    Link website: https://aliffaizar.com/
    Terima kasih

<br>

3.  [https://chichatt.vercel.app/]  
     **by**

    Assalamualaikum pak Dhika dan Rekan" Semua

    Perkenalkan nama saya Akbar,
    Ini showcase project kedua saya yaitu membuat web chating.
    Project ini adalah project belajar firebase saya.
    ...
    Link Website :
    https://chichatt.vercel.app/

    Link Repository:
    https://github.com/Akbaroke/Chichat

<br>

4.  [https://bit.ly/mikunitensai]  
     **MikuniTensai**

    Assalamualaikum pak dhika dan rekan-rekan WPU semua

    Perkenalkan saya Yusuf
    solo dev untuk sebuah game yang saya kembangkan, project yang saya kerjakan ini adalah project solo yang ke 3 setelah game horror pertama untuk skripsi dan game kedua untuk menambah wawasan dalam pemograman dan ini adalah game ke-3 saya. 3 game ini saya kerjakan membutuhkan waktu 1 tahun lebih di kalah ada waktu senggang disetelah pulang kerja.

    Dibuat dengan menggunakan C++ UE 5
    dan beberapa software tools untuk menunjang gamenya
    blender
    subtance painter
    photoshop

    Link game: https://bit.ly/mikunitensai
    Nama game: escape from labyrinth
    Coba di smartphone ya pak, kemungkinan di emulator tidak jalan

    Terima kasih mungkin hanya ini yang bisa saya sampaikan, sekian dan terimakasih.

<br>

5.  [https://panndev.me/wordpress]  
     **PannDev**

    Halo Pak Sandhika dan Kawan - Kawan semua.

    Perkenalkan nama saya Evan, saya ingin membagikan project yang barusan saya buat ketika ada tugas dari sekolah membuat website. Disini saya membuat nya menggunakan wordpress yang di install di localhost menggunakan xampp lalu saya upload dan hosting ke github. Website ini berisi perkenalan singkat diri saya dan saya juga memasukan beberapa project portofolio website saya.
    Website ini seperti web portofolio.

    Berikut beberapa fitur yang sudah saya buat :
    Animasi di website nya
    Navigasi Menu dan Media Sosial
    Maps Google
    Sedikit Quotes
    ...
    Link website : https://panndev.me/wordpress

    Sekian penjelasan dari project saya, kurang lebih nya mohon maaf.

<br>

6.  [https://idn-area.up.railway.app/]  
     **fityannugroho**

    Halo Pak Dhika dan rekan-rekan semuanya! Perkenalkan, saya Fityan, full-stack software engineer.

    Saya ingin membagikan project open API yang saya kembangkan, yaitu:
    idn-area, API yang menyediakan informasi wilayah administrasi di Indonesia mulai dari tingkat provinsi, kabupaten/kota, kecamatan, hingga desa/kelurahan. 

    Link project: https://github.com/fityannugroho/idn-area
    Link demo: https://idn-area.up.railway.app/

    Fitur-Fitur
    Menggunakan data resmi terbaru yang dikeluarkan oleh pemerintah.
    API endpoint yang terdokumentasi dengan baik dan mudah digunakan untuk mengambil data provinsi, kabupaten/kota, kecamatan, dan desa/kelurahan.
    Menggunakan rangkaian tes untuk memastikan validitas sumber data dan juga data keluaran dari setiap endpoint.
    API playground untuk mencoba endpoint dan memeriksa respon (lihat /docs endpoint).

    API ini dikembangkan menggunakan framework NestJS dengan bahasa pemrograman TypeScript, ORM Prisma dan database MongoDB. Kedepannya berencana untuk mendukung jenis database lain seperti MySQL, PostgreSQL, dll.

    Jika rekan-rekan menemukan bug, atau ingin ada fitur baru, atau peningkatan-peningkatan lainnya, jangan sungkan untuk berkontribusi ya.
    Terima kasih semuanya 🙏

<br>

7.  [https://rakitacademy.com/]  
     **Faiz Nurullah**

    Assalamualaikum pak Dhika dan rekan-rekan WPU semua 

    Perkenalkan nama saya nur, seorang junior programmer izin membagikan projects pribadi saya. Disini saya membuat sistem learning management menggunakan laravel, dimana saya sudah berhasil merelease beberapa kelas tutorial secara gratis. Tujuan saya membuat projects ini sebenarnya untuk portofolio pribadi dan untuk membagikan sedikit ilmu yang saya dapatkan dari pembelajaran saya dan memungkinkan juga untuk menjual kelas secara premium karena website ini sudah terintegrasi dengan salah satu payment gateway mungkin buat teman-teman yang ingin menjual tutorial bisa hubungi saya saja, jujur saja website ini saya terinspirasi dari mas Hilman, dan mungkin fitur-fitur nya sedikit mirip dengan punya beliau. Mungkin ini beberapa fitur yang bisa di temukan di sistem LMS yang saya bikin diantaranya adalah: 
    sistem regis/login
    sistem daftar kelas
    sistem claim sertifikat ketika sudah menyelesaikan kelas
    forum diskusi
    grafik track belajar
    grafik track interest

    Link: https://rakitacademy.com/ 

    Semoga kedepannya sistem saya ini bisa membantu dan berguna untuk yang baru belajar dan sudah belajar, terimakasih atas perhatiannya teman-teman

<br>

8.  [https://kabo.vercel.app/]  
     **noosabaktee**

    Halo Pak Dhika dan teman-teman👋  Nama saya Rama Nusa Bakti, izin showcase project. Project kali ini saya coba bikin robot pintar. 
    Kabo adalah robot pintar (kadang tidak) berbasis website yang dibuat menggunakan API chatGPT dari OpenAI. Kabo terinspirasi dari robot-robot pintar yang dibuat menggunakan teknologi AI yang dapat berinteraksi dengan manusia.

    Teknologi: React

    Link: https://kabo.vercel.app/

    Untuk panduannya ada di pojok kanan bawah.

<br>

9.  [https://darren7753-vidio-google-play-store-reviews-dashboard-iajwpn.streamlit.app/]  
     **Silvion**

    Halo selamat sore teman2 semuanya. Perkenalkan, nama saya Darren, izin membagikan personal project saya. Project ini ada kaitannya juga dengan Machine Learning, khususnya NLP. Jadi saya coba membuat sebuah app / dashboard berbasis web yang setiap harinya scraping google play store review buat Vidio.com (kebetulan itu tempat saya intern), kemudian mengelompokkan review2 raw tersebut ke beberapa kategori menggunakan Machine Learning dengan bantuan API GPT. 

    Link Demo: https://darren7753-vidio-google-play-store-reviews-dashboard-iajwpn.streamlit.app/
    Link GitHub Repo: https://github.com/darren7753/vidio_google_play_store_reviews

    Terima kasih 🙏

<br>

10.  [https://merahputih.moe/]  
     **sinkaroid**

    Halo pak Dhik dan kawand kawand weeb dev WPU, nama sy Indrawan izin showcase project.
    MERAHPUTIH.MOE - 📦 Pretty moe & indonesia subdomains for your project UwU

    Projek ini terinspirasi oleh free service JS.ORG subdomain, 
    hanya sj tidak harus JavaScript related, semua bisa ambil terkhusus utk weeb dev UwU

    Stack yg dipakai:
    Next.js
    Tailwind CSS
    Cloudflare DNS
    Indo pride (merahputih.moe) 🇮🇩

    Link: https://merahputih.moe/
    Repository: https://github.com/ScathachGrip/merahputih.moe

    Buat kawand kawand bisa pr kalo pgn memoeify web kalian, go to src/cnames.ts and add https://yourname.merahputih.moe/
...
9.  [https://belanjaan.sampurasun.my.id/]  
     **Eris Sulistina**
        ...
        Tantangan
        Karena pak Dhika tidak menyediakan desain versi mobile (responsif), maka convert CSS juga menjadi tantangan tersendiri bagi saya. Proses convert CSS tidak menggunakan murni CSS seperti yang dilakukan pak Dhika, tapi saya menggunakan TailwindCSS agar sedikit keren, hehe.
        Walaupun alpineJS dan ReactJS sama-sama menawarkan reactivity, namun keduanya memiliki konsep yang berbeda dalam memanipulasi data. Pada react, manipulasi data harus menggunakan method immutable, sedangkan AlpineJS tidak. Sehingga ada perbedaan codingan pada CRUD aplikasi.
        x-if pada AlpineJS tidak fleksible. Saat saya punya kondisi lebih dari satu, maka x-if harus ditulis manual berualang kali dengan kondisinya, dalam artian tidak bisa menggunakan elseif.
        Tantangan terbesar adalah saat coding sorting. Pada react, kondisi pada switch akan terus dijalankan ketika react re-render. Pada AlpineJS, Alpine tidak melakukan re-render, sehingga membuat saya kebingungan mengatasinya. Saya tahu ada x-effect dan $watch yang fungsinya relevan dengan permasalahan ini, tapi saya kurang paham penggunaannya dan bagaimana codingan baiknya. Tapi untungnya, setelah bereksperiment dengan banyak kesalahan, saya menemukan solusinya.
        ...
        Repo & Demo
        Repo: https://github.com/sejutaimpian/catatan-belanja-alpine
