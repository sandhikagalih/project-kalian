...
3.  [https://jalungun.github.io/]  
    ...
    Kritik & Saran akan saya tampung,terima kasih.
...
7.  [https://storesip.masdhika.com/]  
    ...
    Ini adalah pertama kalinya saya mengikuti showcase project, jadi maaf jika masih ada kekurangan pada Website Toko Online, serta mohon kritik dan sarannya.. terima kasih.
...
9.  [https://github.com/FahrulID/virtual-gamepad/releases]  
    ...
    Singkatnya, client ( handphone ) akan mengirimkan perintah dengan menggunakan socket.io sesuai tombol yang ditekan di client kepada server, server ( express js + socket.io ) akan terhubung dengan client dan akan menerimah perintah dari client, lalu setelahnya akan dikirim perintah langsung ke ViGEmBus ( Driver ).
...
10. [https://your-animee-lisstt.vercel.app/]  
    **Minezz**
    ...
    5. React Icon
    6. Vite
    7. API yang digunakan : https://docs.api.jikan.moe/
...
1.  [https://github.com/reacto11mecha/sora]  
     **reacto_mecha!**

    Selamat pagi pak dika, kali ini saya ingin showcase saya.
    Jadi sebelumnya saya sempet showcase project NVA13 buat pemilihan ketua osis tapi ga dipake karena udah kelas 9 dan udah lulus duluan.

    Kali ini saya buat yang baru, namanya ᮞᮧᮛ (Sora) atau artinya suara. Aplikasi ini dibuat pake T3 Stack buatannya theo, sebelumnya di buat pake rest api pada saat bulan puasa, tapi sekitar bulan november saya ubah aja ke T3 Stack soalnya DX sama fiturnya cocok buat kebutuhan saya.

    Saya buat aplikasi ini pake next js, tRPC, typegoose (juga mongoose), chakra ui, luxon, dan next auth. Untuk database menggunakan mongodb. Lama pengerjaannya sekitar 1 bulan kalau di hitung setengan bulan pas puasa sama pada saat pindah ke T3.

    Oiya, aplikasi buatan saya dipake pada saat pemilihan ketua osis yang baru tanggal 1 Desember 2022, alhamdulilah berjalan dengan lancar. Mungkin saya cuma bisa bilang makasih buat pak dika, makasih ilmu yang udah bapak kasih free di yt. Makasih juga buat bang rama sama bang arfy, juga temen-temen di bellshade yang udah ngajarin gimana cara make gh action dan workflow git.

    Mungkin kalo ada yang mau make, udah ada juga video sosialisasi yang bisa di jadiin contoh, link : https://youtu.be/HkfUnqtLCsE (awas copyright pak)

    Untuk cara pakai udah ada di readme repositori, kalo ada yang perlu ditanyain bisa lewat telegram https://t.me/reacto_mecha

    Link repo: https://github.com/reacto11mecha/sora

    Mohon kritik dan sarannya man teman, terimakasih 🙏

<br>

2.  [https://neerdle.netlify.app/]  
     **noosabaktee**

    Halo Pak Dhika dan teman-teman👋 Nama saya Rama Nusa Bakti, izin showcase project. Project kali ini saya coba bikin game nerdle. Mirip game wordle tapi pake operasi matematika.
    Tebak Nerdle dalam 6 percobaan. Setelah setiap tebakan, warna ubin akan berubah untuk menunjukkan seberapa dekat tebakan anda dengan solusinya.

    Teknologi: React & Tailwind

    Link: https://neerdle.netlify.app/

<br>

3.  [https://ti-bidar.com/]  
     **mardiansyah**

    Halo pak Dhika nama saya Muhammad Mardiansyah saya ingin showcase project saya bernama BidarBlog ini adalah website blogging system mirip seperti blogger. Sedikit cerita mengenai project ini ini adalah tugas akhir mata kuliah web programming awalnya hanya ingin menggunakan laravel saja membuat nya sesimpel mungkin agar cepat selesai karena aku setiap mengerjakan tugas tidak terlalu memikirkan nilai yang penting ngumpul 😅 tapi karena aku sudah menyukai web programming hampir 2 tahun berkat Chanel wpu karena itu entah kenapa kayak ada yang kurang gitu kalo di buat simpel jadi aku memutuskan untuk di buat semaksimal mungkin dan menggunakan React JS untuk frontend nya ohh iya project ini beranggotakan 5 orang .

    User yang sudah login sudah bisa membuat sebuah blog tapi blog tidak langsung publish karena harus di izinkan oleh admin terlebih dahulu.
    Akun admin :
    email : admin@gmail.com
    password : password
    Akun biasa :
    ...
    Agar admin bisa approve blog arahkan url ke
    /admin/blogs
    Teknologi yang digunakan
    ...
    - DaisyiUi
    - Laravel
      Link website https://ti-bidar.com/

<br>

4.  [https://love-beige.vercel.app/kuro]  
     **kuro**

    Halo semuanya perkenalkan nama saya ari rachman Dari ITTP, saya mau showcase projek saya yaitu website Bunga 3D sebenernya Ini project Terinpirasi dari trend tiktok yang bunga coding dan juga saya masih pemula mohon maap jika masih jelek dan mungkin saat website saya di review mungkin sudah lewat trend nya 🤣

    link: https://love-beige.vercel.app/kuro
    ...
    \*Note : anda bisa mengedit nama kuro dengan cara mengganti /kuro yang ada di link dengan nama ayang kalian contoh : https://love-beige.vercel.app/kobo

<br>

5.  [https://famous-paletas-d3074d.netlify.app/]  
     **dihpan**

    Haii teman-teman assalamualaikum wr wb, nama saya Aji Mustofa, saya mau showcase simulasi sederhana yang saya buat dengan C++. jadi ini sebuah simulasi petasan, yang waktu itu saya buat untuk memperingati hari raya idul adha

    Demo: https://famous-paletas-d3074d.netlify.app/

    Control:

    - Klik kiri untuk meluncurkan petasannya

    Github Repo: https://github.com/pepega90/fireworks-simulation
...
6.  [https://www.e-statement.in/]  
     **muhfaris**

    Halo Pak Dhika dan teman-teman. saya Faris, izin showcase project E-statement Converter.

    Description:
    Tujuan dari project ini untuk membantu saya terutama dalam mencatat pengeluaran dari aplikasi Grab / Gojek. E-statement yang dikeluarkan oleh Grab / Gojek yang dapat kita download setiap bulannya dalam bentuk PDF, dokumen tersebut dapat diconvert pake aplikasi ini. Hasil csvnya itu sesuai dengan table pada PDF statementnya.
    jadi csv file tersebut nanti bisa di combine jadi 1 file atau 1 sheet dari berbagai Grab / Gojek / Bank Account.
    ...
    Link: https://www.e-statement.in/

    Terimakasih

<br>

7.  [https://github.com/faisalfjri/breeze-react-api]  
     **faisalfjri**

    Assalamu'alaikum Pak Dhika dan semua teman-teman di WPU!

    Perkenalkan nama saya Faisal Fajri, Izin share Authentication starter kit frontend in React.js for Laravel Breeze.
...
8.  [https://marioalrasyid.github.io/]  
     **MRiO\_**

    Holaa semua, ijin ikutan showcase ya pak Dika...sebelumnya perkenalkan saya Mario, mahasiswa Universitas Terbuka jurusan Sistem Informasi baru Semester 1 cuma lagi blm aktif perkuliahan, masih baru belajar coding mengoding kira2 sejak 2-3 bln yg lalu bahasa pemrograman pertama saya python di channel pak Pukis bersama Ucup dan kawan2, sekarang lagi lanjut belajar front end di channel pak Dika baru sampe CSS dan JS dasar....sekarang saya lagi ngerjain project pertama, portfolio website sekaligus sambil belajar fundamentalnya jadi masih beneran SEDERHANA web nya pak 🫣,...

    Untuk assets rata2 saya menggunakan format svg yang saya buat sendiri (sekalian menyalurkan hobi design), kecuali untuk icon saya menggunakan dari font awesome, fitur dan animasi saya cari referensi di internet dan disesuaikan lagi di web saya, webnya baru kerangka besar saja maklum kalau masih banyak bugnya ya :hehehe:
    Untuk form contact, backend nya saya blm buat, jadi fiturnya masih blm berfungsi,

    Ini link nya : https://marioalrasyid.github.io/
    Website saya menggunakan,
    -CSS
    -HTML
    -JavaScript
    (Blm sampe framework apalagi library, masih fokus ke 3 ini ehehe jadi masih pure semua)

    Rencana kedepan nya atau next project saya akan buat fitur-fitur lain seperti chat bot untuk tanya2 tentang informasi saya, membuat page baru tentang detail project dll. Sekalian kalau ada ide dan saran dari temen-temen semua terutama dari pak Dika kalo ada yg kurang atau mungkin tambahan fitur maupun bagian yg mungkin bisa ditambahkan lagi....

    Terimakasih, moga moga bisa jadi inspirasi juga yaa

<br>

9.  [https://openai-project-kappa.vercel.app/]  
     **Arman Dwi Pangestu**

    Halo Pak Dhika dan teman-teman. Saya Arman, izin showcase yang kedua kalinya. Pada showcase kali ini saya membawakan project tentang OpenAI. Project ini adalah sebuah website yang menggunakan API dari OpenAI yang dimana kita dapat berinteraksi dengan ChatGPT dan Dall·E 2. Untuk mencoba nya dapat meng-clone repository nya dan menjalankan nya di localhost lalu menggunakan API Key masing-masing karena API Key yang Saya punya sudah terkena limit😅 .

    Project ini saya buat dengan beberapa teknologi berikut:

    - React JS
    - Tailwind CSS
    - Font Awesome

    Demo: https://openai-project-kappa.vercel.app/
    Repository: https://github.com/armandwipangestu/openai-project

    Terimakasih

<br>

10. [https://goalptn.netlify.app/]  
    **Addien Zakia**

      Assalamualaikum pak dhika dan semuanya izinkan saya untuk showcase project sederhana yang ada saya dan kawan saya buat.
      sebelumnya perkenalkan saya Addien dari kelas 3 sma, ingin showcase project berupa website yang berisi tentang informasi-informasi terkait perubahan jalur masuk perguruan tinggi negeri di tahun 2023 mendatang.
      website ini dibuat oleh saya sebagai developer dan teman saya sebagai yang memberi ide-ide atau isi content yang ada di website ini, dan website ini dibuat sekitar 2 mingguan. Dan juga web ini saya kerjakan pada akhir bulan oktober kemaren, jadi mohon maaf kalau ada info2 yg kurang lengkap di dalam websitenya 🙏
      ...
      Demo: https://goalptn.netlify.app/
      Github: https://github.com/AddienZakia/GoalPTN

      btw website ini adalah website yang saya buat dalam perlombaan, tapi ya walaupun hasilnya tetap harus mencoba lagi wkwkwk, mohon kritik dan sarannya ya.
